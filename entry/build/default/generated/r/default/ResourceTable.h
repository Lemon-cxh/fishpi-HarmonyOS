...
const int32_t COLOR_PRIMARY_COLOR = 0x01000007;
const int32_t COLOR_START_WINDOW_BACKGROUND = 0x01000008;
const int32_t COLOR_TEXT_HINT = 0x01000009;
...
const int32_t MEDIA_ICON_ACTUAL = 0x0100000d;
const int32_t MEDIA_STARTICON = 0x0100000e;
const int32_t MEDIA_STARTICON_ACTUAL = 0x0100000f;
